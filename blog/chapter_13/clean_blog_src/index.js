...
// Parse JSON and URL-encoded form data (built-in in Express 4.16+)
...
app.get('/', async (req, res) => {
    try {
        // Find all blog posts and populate the 'userid' field (get username)
        const blogposts = await BlogPost.find()
            .populate('userid', 'username')
            .sort({ datePosted: -1 }); // optional: newest posts first
...
// Alternate create page (protected)
...
// ---------------------- AUTH ROUTES ----------------------
// Registration (redirect if logged in)
